...
<html lang="pt">
    ...
    <body>
        ...
        <div id="cabessalho" class="d-flex  p-1 my-1 "> 
        ...
        <div id="principal" class="wrapper d-flex align-items-stretch"> 
            ...
            <div id="content" class="p-4 p-md-5 pt-5" >
                ...
                <div id="contenTable"class="table-responsive">
                    ...
                    <table class="table table-striped">
                        <caption>Dados atendimento</caption>
